    ...
    public partial class AddAllergensAndDietaryRestrictions : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("p_k_allergens", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    current_quantity = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    minimum_quantity = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    created_at = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    updated_at = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    transaction_type = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_menu_item_allergens", x => new { x.menu_item_id, x.allergen_id });
                    table.ForeignKey(
                        name: "f_k_menu_item_allergens_allergens_allergen_id",
                        column: x => x.allergen_id,
                        principalTable: "allergens",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "f_k_menu_item_allergens_menu_items_menu_item_id",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    menu_item_id = table.Column<Guid>(type: "uuid", nullable: false),
                    dietary_restriction_id = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_menu_item_dietary_restrictions", x => new { x.menu_item_id, x.dietary_restriction_id });
                    table.ForeignKey(
                        name: "f_k_menu_item_dietary_restrictions_dietary_restrictions_dietary~",
                        column: x => x.dietary_restriction_id,
                        principalTable: "dietary_restrictions",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "f_k_menu_item_dietary_restrictions_menu_items_menu_item_id",
                        column: x => x.menu_item_id,
                        principalTable: "menu_items",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "i_x_menu_item_allergens_allergen_id",
                table: "menu_item_allergens",
                column: "allergen_id");

            migrationBuilder.CreateIndex(
                name: "i_x_menu_item_dietary_restrictions_dietary_restriction_id",
