...
public class UpdateItemHandlerTests
{
    ...
    [Fact]
    public async Task Handle_WithValidRequest_UpdatesMenuItem()
    {
        // Arrange
    ...
    [Fact]
    public async Task Handle_UpdatesAllergens_ReplacesExistingAllergens()
    {
        // Arrange
        await using var context = CreateContext();
        var menuItemId = Guid.NewGuid();
    ...
    [Fact]
    public async Task Handle_UpdatesDietaryRestrictions_ReplacesExistingRestrictions()
    {
        // Arrange
        await using var context = CreateContext();
        var menuItemId = Guid.NewGuid();
