...
public class GetItemHandlerTests
{
    ...
    [Fact]
    public async Task GivenValidId_WhenHandleIsCalled_ThenReturnsMenuItem()
    {
        // Arrange
    ...
    [Fact]
    public async Task GivenItemWithAllergens_WhenHandleIsCalled_ThenReturnsMenuItemWithAllergens()
    {
        // Arrange
        await using var context = CreateContext();
        var menuItemId = Guid.NewGuid();
    ...
    [Fact]
    public async Task GivenItemWithDietaryRestrictions_WhenHandleIsCalled_ThenReturnsMenuItemWithDietaryRestrictions()
    {
        // Arrange
        await using var context = CreateContext();
        var menuItemId = Guid.NewGuid();
