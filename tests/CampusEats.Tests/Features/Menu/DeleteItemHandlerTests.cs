...
public class DeleteItemHandlerTests
{
    ...
    [Fact]
    public async Task Handle_WithValidId_DeletesMenuItem()
    {
        // Arrange
    ...
    [Fact]
    public async Task Handle_DeletesMenuItem_LeavesOtherItemsIntact()
    {
        // Arrange
        await using var context = CreateContext();
    ...
    [Fact]
    public async Task Handle_DeletesMenuItemWithRelations_CascadesCorrectly()
    {
        // Arrange
        await using var context = CreateContext();
        var menuItemId = Guid.NewGuid();
